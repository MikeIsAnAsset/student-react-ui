...
class SignUp extends Component {
    ...
    this.setState({
        // this will give us email:example@gamil.com in our state
        [name]:value
            ...
            <form onSubmit={this.signUpSubmitHandler}  className="container">
                <div className="form-row">
                    <div className="form-group col-md-6">
                        ...
                        <input type="text" onChange={this.signUpChangeHandler} value={this.state.firstName} name="firstName" className="form-control" id="firstName" placeholder="firstName" />
                    </div>
                    <div className="form-group col-md-6">
                        <label htmlFor="lastName">First Name</label>
                        <input type="text" onChange={this.signUpChangeHandler} value={this.state.lastName} name="lastName" className="form-control" id="lastName" placeholder="lastName" />
                    </div>
                    <div className="form-group col-md-6">
                    ...
                    <div className="form-group col-md-6">
                        ...
                        <input type="email" onChange={this.signUpChangeHandler} value={this.state.email} name="email" className="form-control" id="inputEmail4" placeholder="Email" />
                    </div>
                    <div className="form-group col-md-6">
                        <label htmlFor="inputPassword4">Password</label>
                        <input type="password" onChange={this.signUpChangeHandler} name="password" className="form-control" id="inputPassword4" placeholder="Password" />
                    </div>
                </div>
